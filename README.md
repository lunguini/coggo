...
```bash
go install github.com/lunguini/coggo/cmd/coggo@v0.1.2
coggo init
...
Use a version tag such as `@v0.1.2` for a specific stable release. Use `@latest` for the newest tagged release. Use `@main` only if you explicitly want the current development branch.
